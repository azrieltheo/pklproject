...
<body class="bg-gray-200 flex justify-center items-center h-screen">
    <div class="bg-blue-500 w-96 p-8 rounded-xl shadow-lg">
        ...
        <form action="/login" method="POST">
            ...
            <div class="mb-4">
                <input type="email" placeholder="Masukan Email Anda"
                    class="w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
            <div class="mb-6">
        ...
        <!-- Tambahan navigasi jika diperlukan -->
        <div class="text-center mt-4">
            <a href="/dashboard" class="text-white underline">Dashboard (Demo Link)</a>
        </div>
    </div>
</body>
</html>
