      ...
      <nav>
        <ul>
          <li class="px-4 py-2 hover:bg-blue-600">
            <a href="/" class="block">Home</a> <!-- Link ke halaman Home -->
          </li>
          <li class="px-4 py-2 hover:bg-blue-600">
            <a href="/about" class="block">About</a> <!-- Link ke halaman About -->
          </li>
          <li class="px-4 py-2 hover:bg-blue-600">
            <a href="/settings" class="block">Settings</a> <!-- Link ke halaman Settings -->
          </li>
        </ul>
      </nav>
    </aside>
